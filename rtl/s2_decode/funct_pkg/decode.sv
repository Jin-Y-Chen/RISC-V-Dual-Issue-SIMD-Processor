...
// ID-stage decode helpers: immediates, instruction fields, lane_sel, GPR uses, legality.
...
package decode_pkg;
  ...
  // imm_align4 / sign_extend: rv_dis_pkg.sv
  ...
  // 0 = even lane (OP / OP-IMM), 1 = odd lane
  function automatic logic decode_lane_sel(input logic [6:0] opcode);
    unique case (opcode)
      OPC_OP,
      OPC_OP_IMM: decode_lane_sel = 1'b0;
      OPC_LOAD,
      OPC_STORE,
      OPC_BRANCH,
      OPC_JAL,
      OPC_JALR,
      OPC_LUI,
      OPC_AUIPC:  decode_lane_sel = 1'b1;
      default:    decode_lane_sel = 1'b0;
    endcase
  endfunction
