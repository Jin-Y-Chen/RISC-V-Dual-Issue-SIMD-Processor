...
module memory_cache_tb;
  ...
  task automatic log_dut_inputs;
    ...
    tb_field_in_bit("i0_act",   i0_act);
    tb_field_in_u32("i0_addr",  i0_addr);
    tb_field_in_u32("i0_wdata", i0_wdata);
    tb_field_in_u32("i0_besel", {28'b0, i0_besel});
    tb_field_in_bit("i1_act",   i1_act);
    tb_field_in_u32("i1_addr",  i1_addr);
    tb_field_in_u32("i1_wdata", i1_wdata);
    tb_field_in_u32("i1_besel", {28'b0, i1_besel});
  endtask
