...
module ex_mem_tb;
  ...
  task automatic clear_ex;
    ...
    od0_rd_addr_ex = '0; od0_brch_taken_ex = 1'b0; od0_brch_pc_ex = '0;
    ...
    od1_rd_addr_ex = '0; od1_brch_taken_ex = 1'b0; od1_brch_pc_ex = '0;
  ...
  task automatic log_dut_inputs;
    ...
    tb_field_in_bit("stall_od1",         stall_od1);
    tb_field_in_bit("od0_enable_ex",     od0_enable_ex);
    tb_field_in_bit("od0_reg_write_ex",  od0_reg_write_ex);
    tb_field_in_u32("od0_rd_addr_ex",    {27'b0, od0_rd_addr_ex});
    tb_field_in_bit("od0_brch_taken_ex", od0_brch_taken_ex);
    tb_field_in_u32("od0_brch_pc_ex",    od0_brch_pc_ex);
    tb_field_in_bit("od0_mem_en_ex",     od0_mem_en_ex);
    tb_field_in_bit("od0_mem_write_ex",  od0_mem_write_ex);
    tb_field_in_u32("od0_mem_addr_ex",   od0_mem_addr_ex);
    tb_field_in_u32("od0_mem_wdata_ex",  od0_mem_wdata_ex);
    tb_field_in_u32("od0_mem_besel_ex",  {28'b0, od0_mem_besel_ex});
    tb_field_in_u32("od0_link_pc_ex",    od0_link_pc_ex);
    tb_field_in_u32("od0_alu_result_ex", od0_alu_result_ex);
    tb_field_in_bit("od0_use_link_ex",   od0_use_link_ex);
    tb_field_in_u32("od0_pc_ex",         od0_pc_ex);
    tb_field_in_bit("od1_enable_ex",     od1_enable_ex);
    tb_field_in_bit("od1_reg_write_ex",  od1_reg_write_ex);
    tb_field_in_u32("od1_rd_addr_ex",    {27'b0, od1_rd_addr_ex});
    tb_field_in_bit("od1_brch_taken_ex", od1_brch_taken_ex);
    tb_field_in_u32("od1_brch_pc_ex",    od1_brch_pc_ex);
    tb_field_in_bit("od1_mem_en_ex",     od1_mem_en_ex);
    tb_field_in_bit("od1_mem_write_ex",  od1_mem_write_ex);
    tb_field_in_u32("od1_mem_addr_ex",   od1_mem_addr_ex);
    tb_field_in_u32("od1_mem_wdata_ex",  od1_mem_wdata_ex);
    tb_field_in_u32("od1_mem_besel_ex",  {28'b0, od1_mem_besel_ex});
    tb_field_in_u32("od1_link_pc_ex",    od1_link_pc_ex);
    tb_field_in_u32("od1_alu_result_ex", od1_alu_result_ex);
    tb_field_in_bit("od1_use_link_ex",   od1_use_link_ex);
    tb_field_in_u32("od1_pc_ex",         od1_pc_ex);
  endtask
  ...
  task automatic check_od0_mem(
    ...
    bit pass;
    pass = (od0_reg_write_mem === exp_rw) && (od0_rd_addr_mem === exp_rd) &&
    ...
    tb_field_u5("od0_rd_addr_mem", od0_rd_addr_mem, exp_rd);
  ...
  task automatic check_od1_mem(
    ...
    bit pass;
    pass = (od1_reg_write_mem === exp_rw) && (od1_rd_addr_mem === exp_rd) &&
    ...
    tb_field_u5("od1_rd_addr_mem", od1_rd_addr_mem, exp_rd);
