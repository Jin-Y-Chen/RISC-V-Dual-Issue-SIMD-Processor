...
module ex_mem_wb_tb;
  ...
  task automatic log_dut_inputs;
    ...
    tb_field_in_bit("ev0_reg_write_ex",  ev0_reg_write_ex);
    tb_field_in_u32("ev0_rd_addr_ex",    {27'b0, ev0_rd_addr_ex});
    tb_field_in_u32("ev0_wdata_ex",      ev0_wdata_ex);
    tb_field_in_u32("ev0_pc_ex",         ev0_pc_ex);
    tb_field_in_bit("ev1_reg_write_ex",  ev1_reg_write_ex);
    tb_field_in_u32("ev1_rd_addr_ex",    {27'b0, ev1_rd_addr_ex});
    tb_field_in_u32("ev1_wdata_ex",      ev1_wdata_ex);
    tb_field_in_u32("ev1_pc_ex",         ev1_pc_ex);
    tb_field_in_bit("od0_reg_write_mem", od0_reg_write_mem);
    tb_field_in_u32("od0_rd_addr_mem",   {27'b0, od0_rd_addr_mem});
    tb_field_in_u32("od0_pc_mem",        od0_pc_mem);
    tb_field_in_bit("od0_use_link_mem",  od0_use_link_mem);
    tb_field_in_u32("od0_alu_result_mem", od0_alu_result_mem);
    tb_field_in_bit("od0_mem_en_mem",    od0_mem_en_mem);
    tb_field_in_bit("od0_mem_write_mem", od0_mem_write_mem);
    tb_field_in_u32("od0_load_mem_data", od0_load_mem_data);
    tb_field_in_bit("od1_reg_write_mem", od1_reg_write_mem);
    tb_field_in_u32("od1_rd_addr_mem",   {27'b0, od1_rd_addr_mem});
    tb_field_in_u32("od1_pc_mem",        od1_pc_mem);
    tb_field_in_bit("od1_use_link_mem",  od1_use_link_mem);
    tb_field_in_u32("od1_alu_result_mem", od1_alu_result_mem);
    tb_field_in_bit("od1_mem_en_mem",    od1_mem_en_mem);
    tb_field_in_bit("od1_mem_write_mem", od1_mem_write_mem);
    tb_field_in_u32("od1_load_mem_data", od1_load_mem_data);
  endtask
