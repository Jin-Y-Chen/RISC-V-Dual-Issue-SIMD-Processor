...
module id_ex_dispatch_tb;
  ...
  task automatic log_dut_inputs;
    ...
    tb_field_in_bit("commit_en",           commit_en);
    tb_field_in_u2 ("commit_count",        commit_count);
    tb_field_in_bit("set_complete_en",     set_complete_en);
    tb_field_in_u32("set_complete_idx",    {28'b0, set_complete_idx});
    tb_field_in_u32("set_complete_result", set_complete_result);
    tb_field_in_bit("i0_valid_id",         i0_valid_id);
    tb_field_in_bit("i0_lane_sel_id",      i0_lane_sel_id);
    tb_field_in_u32("i0_opcode_id",        {25'b0, i0_opcode_id});
    tb_field_in_u32("i0_funct3_id",        {29'b0, i0_funct3_id});
    tb_field_in_u32("i0_funct7_id",        {25'b0, i0_funct7_id});
    tb_field_in_u32("i0_rd_addr_id",       {27'b0, i0_rd_addr_id});
    tb_field_in_u32("i0_rs1_addr_id",      {27'b0, i0_rs1_addr_id});
    tb_field_in_u32("i0_rs2_addr_id",      {27'b0, i0_rs2_addr_id});
    tb_field_in_bit("i0_reg_write_id",     i0_reg_write_id);
    tb_field_in_u32("i0_imm_id",           i0_imm_id);
    tb_field_in_u32("i0_rs1_data_id",      i0_rs1_data_id);
    tb_field_in_u32("i0_rs2_data_id",      i0_rs2_data_id);
    tb_field_in_u32("i0_pc_id",            i0_pc_id);
    tb_field_in_bit("i1_valid_id",         i1_valid_id);
    tb_field_in_bit("i1_lane_sel_id",      i1_lane_sel_id);
    tb_field_in_u32("i1_opcode_id",        {25'b0, i1_opcode_id});
    tb_field_in_u32("i1_funct3_id",        {29'b0, i1_funct3_id});
    tb_field_in_u32("i1_funct7_id",        {25'b0, i1_funct7_id});
    tb_field_in_u32("i1_rd_addr_id",       {27'b0, i1_rd_addr_id});
    tb_field_in_u32("i1_rs1_addr_id",      {27'b0, i1_rs1_addr_id});
    tb_field_in_u32("i1_rs2_addr_id",      {27'b0, i1_rs2_addr_id});
    tb_field_in_bit("i1_rs1_use_id",       i1_rs1_use_id);
    tb_field_in_bit("i1_rs2_use_id",       i1_rs2_use_id);
    tb_field_in_bit("i1_reg_write_id",     i1_reg_write_id);
    tb_field_in_u32("i1_imm_id",           i1_imm_id);
    tb_field_in_u32("i1_rs1_data_id",      i1_rs1_data_id);
    tb_field_in_u32("i1_rs2_data_id",      i1_rs2_data_id);
