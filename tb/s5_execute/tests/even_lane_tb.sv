...
module even_lane_tb;
  ...
  task automatic check_expect(
    ...
    pass = (alu_result === exp_alu_result);
    tb_report_open(pass, name, detail);
    tb_log_section("inputs");
    tb_field_in_bit("enable",   enable);
    tb_field_in_u32("opcode",   {25'd0, opcode});
    tb_field_in_u32("funct3",   {29'd0, funct3});
    tb_field_in_u32("funct7",   {25'd0, funct7});
    tb_field_in_u32("rs1_data", rs1_data);
    tb_field_in_u32("rs2_data", rs2_data);
  ...
  initial begin
    ...
    check_expect("srai", "SRAI x20, imm12=0x404, shamt=4", 32'hF800_0000);
    run_idle();
