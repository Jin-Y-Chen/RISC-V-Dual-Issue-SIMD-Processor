...
module rename_core_struct_tb;
  ...
  rob_idx_t    i0_rob_idx_disp, i1_rob_idx_disp;
  word_t       i0_imm_disp, i1_imm_disp, i0_pc_disp, i1_pc_disp;
  logic        i0_en, i1_en;
  gpr_addr_t   i0_rd_addr, i1_rd_addr;
  prf_addr_t   i0_prd_tag, i1_prd_tag, i0_prd_old, i1_prd_old;
  ...
  initial begin
    ...
    wback0_en = 1; i0_idx_wb = i0_rob_idx_disp; i0_brch_taken_wb = 0;
    wback1_en = 1; i1_idx_wb = i1_rob_idx_disp; i1_brch_taken_wb = 0;
    i0_reg_write_rn = 0; i1_reg_write_rn = 0;
    @(posedge clk);
    wback0_en = 0; wback1_en = 0;
    @(posedge clk);
    if (!i0_en || !i1_en) $error("expected dual commit");
