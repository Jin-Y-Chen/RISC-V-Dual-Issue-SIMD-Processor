...
module rename_core_struct_tb;
  ...
  gpr_addr_t   i0_rd_rn, i0_rs1_rn, i0_rs2_rn;
  gpr_addr_t   i1_rd_rn, i1_rs1_rn, i1_rs2_rn;
  ...
  gpr_addr_t   i0_rd_disp, i1_rd_disp;
  ...
  gpr_addr_t   commit0_rd, commit1_rd;
  ...
  initial begin
    ...
    i0_rd_rn = '0; i0_rs1_rn = '0; i0_rs2_rn = '0;
    i1_rd_rn = '0; i1_rs1_rn = '0; i1_rs2_rn = '0;
    ...
    i0_rd_rn = 5'd1; i0_rs1_rn = 5'd2; i0_rs2_rn = 5'd3;
    i1_rd_rn = 5'd4; i1_rs1_rn = 5'd1; i1_rs2_rn = 5'd5; // I1 reads I0 rd
