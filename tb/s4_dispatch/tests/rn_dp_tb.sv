...
module rn_dp_tb;
  ...
  logic i0_valid_rn, i0_lane_sel_rn, i0_reg_write_rn;
  ...
  logic i1_valid_rn, i1_lane_sel_rn, i1_reg_write_rn;
  ...
  initial begin
    ...
    i0_valid_rn = 0; i0_lane_sel_rn = 0; i0_reg_write_rn = 0;
    ...
    i1_valid_rn = 0; i1_lane_sel_rn = 0; i1_reg_write_rn = 0;
