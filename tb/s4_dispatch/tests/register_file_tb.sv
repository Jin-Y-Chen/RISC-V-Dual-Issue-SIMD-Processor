...
module register_file_tb;
  ...
  task automatic check_rf(
    ...
    tb_field_in_bit("i1_rs1_use",  i1_rs1_use);
    tb_field_in_bit("i1_rs2_use",  i1_rs2_use);
    tb_field_in_u32("i0_rs1_addr", {27'd0, i0_rs1_addr});
    tb_field_in_u32("i0_rs2_addr", {27'd0, i0_rs2_addr});
    tb_field_in_u32("i1_rs1_addr", {27'd0, i1_rs1_addr});
    tb_field_in_u32("i1_rs2_addr", {27'd0, i1_rs2_addr});
    tb_field_in_bit("i0_valid_wb", i0_valid_wb);
    tb_field_in_u32("i0_rd_addr",  {27'd0, i0_rd_addr});
    tb_field_in_u32("i0_data_wb",  i0_data_wb);
    tb_field_in_bit("i1_valid_wb", i1_valid_wb);
    tb_field_in_u32("i1_rd_addr",  {27'd0, i1_rd_addr});
    tb_field_in_u32("i1_data_wb",  i1_data_wb);
    $display("");
