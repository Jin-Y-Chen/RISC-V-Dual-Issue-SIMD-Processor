# Rename-stage UVM environment (paths relative to repo root)
+incdir+tb/uvm/common
+incdir+tb/uvm/rename
...
tb/uvm/common/rv_base_pkg.sv
tb/uvm/rename/rename_if.sv
tb/uvm/rename/rename_pkg.sv
tb/uvm/rename/top/rename_tb_top.sv
