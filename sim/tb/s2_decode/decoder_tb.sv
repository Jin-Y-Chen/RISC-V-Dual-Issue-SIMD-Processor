...
module decoder_tb;
  ...
  task automatic check_expect(
    ...
    pass = (valid === exp_valid && lane_sel === exp_lane &&
            ...
            reg_write === exp_reg_write && brch_en === exp_brch_en);
    ...
    tb_field_bit("brch_en", brch_en, exp_brch_en);
