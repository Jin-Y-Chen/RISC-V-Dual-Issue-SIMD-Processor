...
module scoreboard_tb;
  ...
  task automatic check_issue(
    ...
    tb_field_bit("bundle_raw", bundle_raw, exp_raw);
  ...
  initial begin
    ...
    i0_valid = 1'b1; i0_reg_write = 1'b1; i0_rd = 5'd5;
    i1_valid = 1'b1; i1_rs1 = 5'd6;
    check_issue("dual_issue_clean", "no hazard: issue both",
                1'b1, 1'b1, 1'b0, 1'b0, 1'b0, 2'd1);

    clear_inputs();
    i0_valid = 1'b1; i0_reg_write = 1'b1; i0_rd = 5'd5;
    i1_valid = 1'b1; i1_rs1_use = 1'b1; i1_rs1 = 5'd5;
    check_issue("bundle_raw_partial", "ALU RAW: I0 only, buffer I1, stall 1",
                1'b1, 1'b0, 1'b1, 1'b1, 1'b1, 2'd1);

    clear_inputs();
    i0_valid = 1'b1; i0_reg_write = 1'b1; i0_rd = 5'd2;
    i0_opcode = OPC_LOAD;
    i1_valid = 1'b1; i1_rs1_use = 1'b1; i1_rs1 = 5'd2;
    check_issue("load_use_capture", "load-use RAW: buffer I1, stall 2",
                1'b1, 1'b0, 1'b1, 1'b1, 1'b1, 2'd2);

    clear_inputs();
    buf_valid = 1'b1;
    issue_i1_from_hold = 1'b0;
    check_issue("buf_wait_count", "buffer valid: full stall while waiting",
                1'b0, 1'b0, 1'b1, 1'b0, 1'b0, 2'd1);

    issue_i1_from_hold = 1'b1;
    check_issue("buf_replay_ready", "replay pulse: issue buffered I1",
                1'b0, 1'b1, 1'b0, 1'b0, 1'b0, 2'd1);
